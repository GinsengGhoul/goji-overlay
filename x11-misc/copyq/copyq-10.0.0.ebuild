...
SRC_URI="https://github.com/hluk/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
         https://raw.githubusercontent.com/GinsengGhoul/goji-overlay/refs/heads/master/x11-misc/copyq/0001-Fix-QChar-construction-for-Qt-6.9.patch"
S="${WORKDIR}/CopyQ-${PV}"
...
# used in tests
PATCHES=("${DISTDIR}"/0001-Fix-QChar-construction-for-Qt-6.9.patch)
